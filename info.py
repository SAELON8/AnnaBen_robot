...
LOG_STR += (f"FILE_NAME enabled with value {FILE_NAME}, your files will be send along with this customized File name.\n" if FILE_NAME else "No FILE_NAME Found, Default file name of file will be used.")
